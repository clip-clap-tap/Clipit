        ...
        <div class="container px-4 py-12 max-w-7xl">
            <!-- <div class="md:flex md:-mx-3 md:items-center md:justify-between">
                ...
                <div class="mt-6 md:mx-3 shrink-0 md:mt-0 md:w-auto">
                    <a
                        href="#"
                        class="inline-flex items-center justify-center w-full px-4 py-2 text-sm text-white duration-300 bg-sky-500 rounded-lg hover:bg-sky-600 focus:ring focus:ring-sky-300 focus:ring-opacity-80"
                    >
